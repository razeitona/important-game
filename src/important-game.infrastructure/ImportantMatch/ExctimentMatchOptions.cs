...
namespace important_game.infrastructure.ImportantMatch
{
    ...
    public class ExctimentMatchOptions
    {
        ...
        public List<MatchImportanceLeague> Leagues = new List<MatchImportanceLeague>
        {
            ...
            new MatchImportanceLeague(17, "Inglaterra", 0.95d, "#3c1c5a", "#3d195b"),
            ...
            new MatchImportanceLeague(37, "Netherlands", 0.70d, "#122e62", "#122e62"),
            new MatchImportanceLeague(325, "Brasil", 0.70d, "#141528", "#C7FF00"),
            new MatchImportanceLeague(155, "Argentina", 0.65d, "#004a79", "#33c5df"),
            new MatchImportanceLeague(52, "Turkey", 0.65d, "#f00515", "#f00918"),
