...
namespace important_game.web.Pages
{
    ...
    {
        private readonly ILogger<OldIndexModel> _logger;
        ...
        public OldIndexModel(ILogger<OldIndexModel> logger, IExcitmentMatchProcessor excitmentMatchProcessor)
        {
            _logger = logger;
        ...
        public async Task OnGet()
        {
            ...
            {
                excitementMatches = await _excitmentMatchProcessor.GetUpcomingExcitementMatchesAsync(new ExctimentMatchOptions());
